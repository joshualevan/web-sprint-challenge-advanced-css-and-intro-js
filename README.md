...
1. How would you describe acessibility on the web to someone new to programming?
    ...
    Web accessibility means that your website is designed keeping in mind tools and software used by those with disabilities browsing the web. Things such as alt tags and semantic html aid these tools. 

2. Talk about 3 different things you can do to ensure your website is accessible. 

    Alt tags describe images.
    Semantic divs allow the user to know what area of the site they are in.
    Large font sizes and high contrast aid the sight-impaired.
    

3. How would you explain the concept of a variable to someone new to programming?

    A variable is a way to store and access a piece of data.

4. What is the purpose of using functions in code?

    Functions are repeatable blocks of code which return a result. Some can take in parameters— pieces of data a function can use or alter.
